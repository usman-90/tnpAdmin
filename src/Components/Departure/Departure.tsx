...
const TimeSlots = [
  ...
  { starttime: "12:00pm", endtime: "1:00pm" },
  { starttime: "1:00pm", endtime: "2:00pm" },
  { starttime: "2:00pm", endtime: "3:00pm" },
  { starttime: "3:00pm", endtime: "4:00pm" },
  { starttime: "4:00pm", endtime: "5:00pm" },
  { starttime: "5:00pm", endtime: "6:00pm" },
  { starttime: "6:00pm", endtime: "7:00pm" },
  { starttime: "7:00pm", endtime: "8:00pm" },
  { starttime: "8:00pm", endtime: "9:00pm" },
  { starttime: "9:00pm", endtime: "10:00pm" },
  { starttime: "10:00pm", endtime: "11:00pm" },
  { starttime: "11:00pm", endtime: "12:00am" },
];
    ...
    <div className="w-full flex flex-col gap-4">
      ...
      <div className="flex flex-row gap-2 w-full overflow-x-auto">
        {TimeSlots.map((item, index) => (
          <Button
            key={67 + index}
            className="flex flex-row bg-sky-500 text-white"
          >
