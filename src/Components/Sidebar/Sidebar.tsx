  ...
  return (
    <>
      <div
        ...
        <div
          className={`flex flex-col items-center rounded-lg mx-2 py-2 ${
          ...
          <div
            ...
            } text-center animate-width py-2 text-sm bg-secondary rounded px-12`}>
            {isDarkMode ? "Dark Mode" : "Light Mode"}
          </div>
          <div className={`py-2 text-sm ${isCollapsed ? "w-0 hidden" : ""}`}>
            <button onClick={toggleCollapse}>
              {isCollapsed ? "Show Mode" : "Hide Mode"}
            </button>
          </div>
        </div>
      </div>
